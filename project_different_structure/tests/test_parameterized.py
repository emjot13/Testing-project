...
class Tests_edit_grade(unittest.TestCase):
    def setUp(self):
        self.temp = E_gradebook()
        self.temp.add_student("Kasia K")
        self.temp.add_subject(0, "matma")
        self.temp.add_grade(0, "matma", "spr", 5)
    ...
    def test_parameterized_add_grade(self, index, subject, description, grade, output):
        self.temp.edit_grade(index, subject, description, grade)
        self.assertEqual(output, self.temp.students[0][1]["matma"]["spr"])
    ...
    def test_parameterized_non_existent_index(self, index, subject, description, grade):
        self.assertRaises(Exception, self.temp.edit_grade, index, subject, description, grade)
    ...
    def test_parameterized_incorrect_description(self, index, subject, description, grade):
        self.assertRaises(Exception, self.temp.edit_grade, index, subject, description, grade)
